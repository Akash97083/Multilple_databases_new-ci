...
<?php endif; ?>
            ...
            <a class="btn btn-success btn-sm" href="<?php echo base_url('admin/costomer/add_new_costomer_excel'); ?>"> <i class="ace-icon fa glyphicon-plus white" title="Add Item"></i> Upload Excel</a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				$i = '1';
					...
					{
						$editLink = base_url('admin/costomer/add_costomer/').$row['id'];
				?>
                <tr id="tr<?php echo $row['id']; ?>">
                  <td><?php echo $i; ?></td>
                   <td><?php echo $row['sap_sold_to']; ?></td>
...
function change_status(id){
	...
	{
		$.ajax({
			url : '<?php echo base_url('admin/costomer/changestatus/'); ?>',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
