...
<?php endif; ?>
            ...
            <a class="btn btn-success btn-sm" href="<?php echo base_url('admin/Item/add_new_item_excel'); ?>"> <i class="ace-icon fa glyphicon-plus white" title="Add Item"></i> Upload Excel</a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Material Code</th>
                  <th>Material Name</th>
                  <th>Cold Chain / Non Cold Chain</th>
                  <th>Fixed weight</th>
                  <th>Status</th>
                  <th>Action</th>
                </tr>
				...
				$i = '1';
					...
					{
						$editLink = base_url('admin/Item/add_item/').$row['id'];
				?>
                <tr id="tr<?php echo $row['id']; ?>">
                  <td><?php echo $i; ?></td>
                   <td><?php echo $row['material_code']; ?></td>
                   <td><?php echo $row['material_name']; ?></td>
                  <td><?php echo $row['cold_chain_non_cold_chain']; ?></td>
                  <td><?php echo $row['fixed_weight']; ?></td>
