...
<?php endif; ?>
            ...
            <div class="box-header">
             ...
             <a class="btn btn-success btn-sm" href="<?php echo base_url('admin/company/add_company'); ?>" title="Add User"> <i class="ace-icon fa glyphicon-plus white"></i> Add New </a>
              </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				$i = '1';
					...
					{
						$editLink = base_url('admin/company/add_company/').$row['id'];
				?>
...
function change_status(id){
	...
	{
		$.ajax({
			url : '<?php echo base_url('admin/company/changestatus/'); ?>',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
