...
<?php endif; ?>
            ...
            <div class="box-header">
              <h3 class="box-title pull-right">
                 <a class="btn btn-success btn-sm" href="<?php echo base_url('admin/branch/add_branch'); ?>" title="Add New Branch"> <i class="ace-icon fa glyphicon-plus white"></i> Add New </a>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$i = '1';
					foreach($recordset as $row)
					{
						...
						$editLink = base_url('admin/branch/add_branch/').$row['id'];
				?>
...
function change_status(id){
	...
	{
		$.ajax({
			url : '<?php echo base_url('admin/branch/changestatus/'); ?>',
			type : 'POST',
			data : 'id=' + id,
			//dataType : 'json',
