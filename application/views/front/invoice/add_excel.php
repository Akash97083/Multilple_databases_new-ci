        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
           ...
           <?php endif; ?>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="frm_user" name="frm_user" method="post" action="<?php echo base_url('user_invoice/add_new_excel_data/'); ?>" enctype="multipart/form-data">
              <div class="box-body">
             ...
             <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="file" id="excel_file" name="excel_file" placeholder="Upload New Excel File" class="col-xs-10 col-sm-5 form-control" value="">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
